...
/**
 * Pantalla de creación / edición de una nota.
 * Si llega un EXTRA_NOTE_ID válido, entra en modo edición; si no, modo creación.
 */
public class NoteDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Recibe el id de la nota (paso de datos por id vía Intent explícito)
